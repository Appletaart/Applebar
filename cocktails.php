<?php include("includes/header_product.php") ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark my-3 px-0 px-lg-3">
        ...
        <div class="col-5 col-lg-5">
            ...
            $query = "SELECT COUNT(*) as items FROM products WHERE category_id =1";
                ...
                <div id="<?php echo $data->id;?>" class="col-12 col-lg-4 p-0 card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row pl-3 align-items-end">
                            <a href="admin/add_to_cart_cocktails.php?action=add&id=<?php echo $data->id;?>&page=<?php echo $paginate->current_page; ?>" class="btn btn-danger col-6">tap to order</a><h5 class="card-title col-5"> € <?php echo $data->price; ?></h5>
                        </div>
                    </div>
                </div>
