<?php include("includes/header_product.php") ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark my-3 px-0 px-lg-3">
        ...
        <div class="col-5 col-lg-5">
            ...
            $query = "SELECT COUNT(*) as items FROM products WHERE category_id =3";  //3
                    ...
                    <ul class="pagination pagination-sm justify-content-center m-0">
                        ...
                        if ($paginate->page_total()>1){
                            ...
                            if($paginate->has_previous()){
                                ...
                                echo '<li class="previous page-item"><a class="page-link bg-light text-danger border-0" href="aperitief_d.php?page='.$paginate->previous().'">Previous</a></li>';

                            }
                            for ($i = 1; $i <= $paginate->page_total(); $i++){
                                if ($i == $paginate->current_page){

                                    echo '<li class="active page-item"><a class="page-link bg-danger border-0" href="aperitief_d.php?page='. $i .'"> '. $i .' </a></li>';

                                }else{

                                    echo '<li class="page-item"><a class="page-link bg-light text-danger border-0" href="aperitief_d.php?page='. $i .'"> ' . $i .' </a></li>';
                                }

                            }
                            if ($paginate->has_next()){

                                echo '<li class="next page-item"><a class="page-link bg-light text-danger border-0" href="aperitief_d.php?page='.$paginate->next().'">Next</a></li>';
    ...
    <div id="<?php echo $paginate->current_page; ?>">
        ...
        <div class="card-group d-flex flex-wrap">
            ...
            $sql = "SELECT * FROM products WHERE category_id =3 "; //3
                ...
                <div id="<?php echo $data->id;?>" class="col-12 col-lg-4 p-0 card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row pl-3 align-items-end">
                            <a href="admin/add_to_cart_aperitief_d.php?action=add&id=<?php echo $data->id;?>&page=<?php echo $paginate->current_page; ?>" class="btn btn-danger col-6">tap to order</a><h5 class="card-title col-5"> € <?php echo $data->price; ?></h5>
                        </div>
                    </div>
                </div>
